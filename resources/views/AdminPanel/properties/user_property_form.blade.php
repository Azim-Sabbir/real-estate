...
@section('main-section')
    <div class="container">
        <div class="container-fluid">
            ...
            <div class="mt-4">
                <form class="card" style="width:90%;" id="proForm" action="{{ route('property_request_update', $pro->id) }}" method="POST"
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-auto">
                                <button
                                    ...
                                    @else btn-primary
                                    @endif"
                                    type="submit">@if (!empty($pro) && $pro->status === "pending") Accept @else Reject @endif
                                </button>
                            </div>
                        </div>
                    </div>
